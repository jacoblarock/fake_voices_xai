...
def train(eval_until: int):
    ...
    pitch_fluc_5_model = networks.create_cnn_1d(30, 32, 3, pooling=False, output_size=30, name="pitch_flucs")
    pitch_fluc_10_model = networks.create_cnn_1d(30, 32, 3, pooling=False, output_size=30, name="pitch_flucs")
    ...
    histories = classification.train(labels, feature_names, model, 1, batch_size=1000000, features=features, batch_method="samples", save_as="ItW_only_percep_u23833")
...
if __name__ == "__main__":
    ...
    """
    train(23833)
    eval("models/ItW_only_percep_u23833", 23833)
